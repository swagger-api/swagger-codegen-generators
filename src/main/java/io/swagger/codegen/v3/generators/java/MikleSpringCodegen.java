...
public class MikleSpringCodegen extends AbstractJavaCodegen implements BeanValidationFeatures, OptionalFeatures {
    static Logger LOGGER = LoggerFactory.getLogger(MikleSpringCodegen.class);
    ...
    public void processOpts() {
        ...
        if (StringUtils.isBlank(templateDir)) {
            embeddedTemplateDir = templateDir = "mustache" + File.separator + "MikleJavaSpring";
        }
     ...
     */
    private void doDataTypeAssignment(String returnType, MikleSpringCodegen.DataTypeAssigner dataTypeAssigner) {
