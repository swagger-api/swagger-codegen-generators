...
public class PythonClientCodegen extends DefaultCodegenConfig {
    ...
    public String getTypeDeclaration(Schema propertySchema) {
        if (propertySchema instanceof ArraySchema) {
            ...
            return getSchemaType(propertySchema) + "[" + getTypeDeclaration(inner) + "]";
        } else if (propertySchema instanceof MapSchema) {
            MapSchema mapSchema = (MapSchema) propertySchema;
            Schema inner = (Schema) mapSchema.getAdditionalProperties();

            return getSchemaType(propertySchema) + "(str, " + getTypeDeclaration(inner) + ")";
        }
    ...
    public String toDefaultValue(Schema schema) {
        if (schema instanceof StringSchema) {
            StringSchema dp = (StringSchema) schema;
            ...
            BooleanSchema dp = (BooleanSchema) schema;
            if (dp.getDefault() != null) {
            ...
            NumberSchema dp = (NumberSchema) schema;
            if (dp.getDefault() != null) {
                return dp.getDefault().toString();
            }
        } else if (schema instanceof IntegerSchema) {
            IntegerSchema dp = (IntegerSchema) schema;
            if (dp.getDefault() != null) {
                return dp.getDefault().toString();
            }
        }
