...
public class ScalaCaskCodegen extends AbstractScalaCodegen {
    ...
    public void processOpts() {
...

        {
            ...
            System.out.println("\n" +
                "   _____           _          _____          _    \n" +
                "  / ____|         | |        / ____|        | |   \n" +
                " | (___   ___ __ _| | __ _  | |     __ _ ___| | __\n" +
                "  \\___ \\ / __/ _` | |/ _` | | |    / _` / __| |/ /\n" +
                "  ____) | (_| (_| | | (_| | | |___| (_| \\__ \\   < \n" +
                " |_____/ \\___\\__,_|_|\\__,_|  \\_____\\__,_|___/_|\\_\\\n" +
                "                                                  \n" +
                "                                                  \n" +
                formatMap(settings) + "\n\n"
            );
    ...
    public static class ParamPart {
        ...
        public CodegenParameter getParam() {
            return param;
        }
        ...
        public boolean getHasMoreParams() {
        ...
        public ParamPart(String name, CodegenParameter param) {
            ...
            this.hasMore = true;
            this.conversion = !isParam || param.getIsString() ? "" : ".to" + param.dataType;
        }
    }
    ...
    public static class OperationGroup {
        ...
        public String getCaskAnnotation() {
            return caskAnnotation;
        }
        ...
        public List<CodegenParameter> getGroupQueryParams() {
            ...
            if (!list.isEmpty()) {
                ...
                list.forEach(p -> {
                    boolean hasMore = !p.equals(last);
                    p.getVendorExtensions().put("x-has-more", hasMore);
                    assert (p.getHasMore() == hasMore);
                });
            }
            return list;
        }
    ...
    public Map<String, Object> postProcessOperations(Map<String, Object> objs) {
        ...
        objs.put("hasEmptyRouteGroup", trimmed.stream().filter(g -> g.getPathPrefix().isEmpty()).count() > 0);
    ...
    private static String defaultValueNonOption(CodegenParameter p) {
        if (p.getIsListContainer()) {
            return "Nil";
        }
        if (p.getIsMapContainer()) {
            return "Map.empty";
        }
        if (p.getIsNumber()) {
            return "0";
    ...
    static String pretty(CodegenResponse response) {
        ...
        map.put("isListContainer", response.getIsListContainer());
        map.put("isMapContainer", response.getIsMapContainer());
    ...
    static String pretty(CodegenParameter response) {
        ...
        map.put("isFile", response.getIsFile());
        map.put("isEnum", response.getIsEnum());
